...
from traka_automation.enrollments.mollie_connection.dummy_payment_link import DummyPaymentLink
...
def generate_payment_link(name: str, camp: str, amount: float, end_date: datetime) -> PaymentLink:
